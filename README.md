...
Celá simulace lze spustit souborem `simulation_complete.sh`. První krok simulace, náhodný výběr variant z katalogu **GnomAD** (verze v2.1.1) vyžaduje velký soubor `gnomad.genomes.r2.1.1.sites.22.vcf.bgz` (https://gnomad.broadinstitute.org/downloads#v2). Proto je přiložen soubor `simulated_indiv_chr22.vcf` s již vybranými variantami.  
